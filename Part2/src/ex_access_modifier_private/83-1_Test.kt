...
public fun hello(value: Int)        // 어디에서나 접근 가능 - public 접근 지정자 생략 가능
{
    num = value
    print()
}

public class Person(age: Int)       // 어디에서나 접근 가능 - public 접근 지정자 생략 가능
{
    // default Setter를 private으로 지정 / Setter는 Person 클래스 내부에서만 접근
    public var age = age
        private set
