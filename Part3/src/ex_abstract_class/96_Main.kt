...
// 단순히 학생, 교수, 직원 class를 하나의 type으로 묶어주는 클래스
abstract class Person
{
    abstract fun getSalary(): Int
}

// 학생 class. tuition는 한 학기 등록금
...
{
    val finance = getFinance(Student(330), Student(330),
        Professor(1), Professor(2), Employee(1300, 2))
